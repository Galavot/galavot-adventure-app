export const TOURS = [
  {
    ...
    price: 350,
    maxQuadriciclos: 5,
    // Reserva pro passeio de HOJE só é aceita até essa hora (0-23), pra
    // não atrapalhar o preparo/saída do grupo. Não afeta reservas pra
    // outros dias, só o dia em que o passeio já vai sair em breve.
    cutoffHour: 8,
